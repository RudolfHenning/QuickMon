...
{
    public class PerfCounterCollectorUI : IWinFormsUI
    {
        public string AgentType { get { return "PerfCounterCollector"; } }
        ...
        public bool EditAgent()
        {
            ...
            if (agent != null)
            {
                ...
                editCollectorAgentEntries.DetailEditor = new PerfCounterCollectorEditEntry();
