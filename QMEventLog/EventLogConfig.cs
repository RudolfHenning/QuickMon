...
namespace QuickMon
{
    internal class EventLogConfig
    {
        public EventLogConfig()
        {
            Entries = new List<QMEventLogEntry>();
        }

        public List<QMEventLogEntry> Entries { get; set; }
        ...
        public void ReadConfiguration(XmlDocument config)
        {
            ...
            {
                QMEventLogEntry eventLogEntry = new QMEventLogEntry();
        ...
        public string ToConfig()
        {
            ...
            config.LoadXml(Properties.Resources.QMEventLogEmptyConfig);
            XmlElement root = config.DocumentElement;
            XmlNode eventLogsNode = root.SelectSingleNode("eventlogs");
            eventLogsNode.InnerXml = "";

            foreach (QMEventLogEntry eventLogEntry in Entries)
            {
