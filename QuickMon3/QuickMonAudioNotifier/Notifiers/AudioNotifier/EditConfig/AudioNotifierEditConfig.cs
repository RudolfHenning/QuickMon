...
{
    public partial class AudioNotifierEditConfig :  SimpleNotifierEditConfig
    {
        public AudioNotifierEditConfig()
        {
            InitializeComponent();
        }
        ...
        private void AudioNotifierEditConfig_Load(object sender, EventArgs e)
        {
            SetSoundSystemOrNot();
        }
        ...
        private void cboWarningSystemSound_SelectedIndexChanged(object sender, EventArgs e)
        {
            CheckOKEnabled();
        }

        private void cboErrorSystemSound_SelectedIndexChanged(object sender, EventArgs e)
        {
            CheckOKEnabled();
        }
