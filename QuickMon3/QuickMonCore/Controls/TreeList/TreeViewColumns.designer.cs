namespace HenIT.Controls
{
	partial class TreeViewColumns
	{
		...
		private void InitializeComponent()
		{
			...
			this.thisTreeView = new System.Windows.Forms.TreeView();
			this.SuspendLayout();
			// 
			// listView1
			// 
			...
			// thisTreeView
			// 
			this.thisTreeView.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.thisTreeView.CheckBoxes = true;
			this.thisTreeView.Dock = System.Windows.Forms.DockStyle.Fill;
			this.thisTreeView.DrawMode = System.Windows.Forms.TreeViewDrawMode.OwnerDrawAll;
			this.thisTreeView.HideSelection = false;
			this.thisTreeView.Location = new System.Drawing.Point(0, 20);
			this.thisTreeView.Name = "thisTreeView";
			...
			this.thisTreeView.Nodes.AddRange(new System.Windows.Forms.TreeNode[] {
            treeNode10,
            treeNode14,
            treeNode20,
            treeNode21});
			this.thisTreeView.Size = new System.Drawing.Size(438, 164);
			this.thisTreeView.TabIndex = 2;
			this.thisTreeView.DrawNode += new System.Windows.Forms.DrawTreeNodeEventHandler(this.thisTreeView_DrawNode);
			this.thisTreeView.Click += new System.EventHandler(this.thisTreeView_Click);
			// 
			// TreeViewColumns
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.Controls.Add(this.thisTreeView);
        ...
        private System.Windows.Forms.TreeView thisTreeView;
	}
}
