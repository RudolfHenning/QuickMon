...
{
    public class MiniDetailView : Form, INotivierViewer, ICollectorDetailView
    {
        ...
        private void LocalInitializeComponent()
        {
            ...
            this.toolStripMain.Size = new System.Drawing.Size(504, 39);
        ...
        public virtual void ShowNotifierViewer(INotifier notifier)
        {
            Notifier = notifier;
            Show();
            LoadDisplayData();
        ...
        public virtual void RefreshConfig(INotifier notifier)
        {
            this.Notifier = null;
