...
{
    public partial class SMTPNotifierEditConfig : SimpleNotifierEditConfig
    {
        //private SMTPNotifierConfig mailSettings = new SMTPNotifierConfig();
        public SMTPNotifierEditConfig()
        {
            InitializeComponent();
        }
        ...
        public override void LoadEditData()
        {
            ...
            if (SelectedEntry != null)
                ...
                mailSettings = (SMTPNotifierConfig)SelectedConfig;
        ...
        {
            SetOKEnabled(txtSMTPServer.Text.Length > 0 && txtFromAddress.Text.Length > 0 &&
