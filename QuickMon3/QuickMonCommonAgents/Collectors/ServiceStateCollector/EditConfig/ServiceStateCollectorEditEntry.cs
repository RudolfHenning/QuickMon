...
{
    public partial class ServiceStateCollectorEditEntry : Form, IEditConfigEntryWindow
    {
        ...
        private void cmdOK_Click(object sender, EventArgs e)
        {
            if (lstServices.Items.Count > 0)
            {
                ...
                {
                    selectedEntry.SubItems.Add(new ServiceStateServiceEntry() { Description = lstServices.Items[i].ToString() });
                }
