...
namespace QuickMon
{
    public partial class EditConfigEntry : Form
    {
        ...
        public WMIConfigEntry WmiIConfigEntry { get; set; }
        ...
        {
            txtName.Text = WmiIConfigEntry.Name;
            txtNamespace.Text = WmiIConfigEntry.Namespace == null ? "root\\CIMV2" : WmiIConfigEntry.Namespace;
            txtMachines.Text = WmiIConfigEntry.Machinename == null ? "." : WmiIConfigEntry.Machinename;
            txtStateQuery.Text = WmiIConfigEntry.StateQuery;
            chkIsReturnValueInt.Checked = WmiIConfigEntry.ReturnValueIsInt;
            chkReturnValueNotInverted.Checked = !WmiIConfigEntry.ReturnValueInverted;
            chkUseRowCountAsValue.Checked = WmiIConfigEntry.UseRowCountAsValue;
            cboSuccessValue.Text = WmiIConfigEntry.SuccessValue;
            cboWarningValue.Text = WmiIConfigEntry.WarningValue;
            cboErrorValue.Text = WmiIConfigEntry.ErrorValue;
            txtDetailQuery.Text = WmiIConfigEntry.DetailQuery;
            txtColumnNames.Text = WmiIConfigEntry.ColumnNames.ToCSVString();
        ...
        private void cmdOK_Click(object sender, EventArgs e)
        {
            if (DoValidate())
            {
                WmiIConfigEntry.Name = txtName.Text;
                WmiIConfigEntry.Namespace = txtNamespace.Text;
                WmiIConfigEntry.Machinename = txtMachines.Text;
                WmiIConfigEntry.StateQuery = txtStateQuery.Text;
                WmiIConfigEntry.ReturnValueIsInt = chkIsReturnValueInt.Checked;
                WmiIConfigEntry.ReturnValueInverted = !chkReturnValueNotInverted.Checked;
                WmiIConfigEntry.UseRowCountAsValue = chkUseRowCountAsValue.Checked;
                WmiIConfigEntry.SuccessValue = cboSuccessValue.Text;
                WmiIConfigEntry.WarningValue = cboWarningValue.Text;
                WmiIConfigEntry.ErrorValue = cboErrorValue.Text;
                WmiIConfigEntry.DetailQuery = txtDetailQuery.Text;
                WmiIConfigEntry.ColumnNames = txtColumnNames.Text.ToListFromCSVString();
