...
if (Test-Path $filePath){
    ...
    $str = "Latest exe version: " +  $major.ToString() + "." + $minor.ToString() + "." + $build.ToString()
    $str
}
...
if (Test-Path $sourcex86Msi){
    ...
    $minor = [int]$versionArray[1]
    $build = [int]$versionArray[2]
    $installerVersionNamex86 = "QuickMon" + $major + "." + $minor + "." + $build + ".msi"
...
if (Test-Path $sourcex64Msi){
    ...
    $minor = [int]$versionArray[1]
    $build = [int]$versionArray[2]
    $installerVersionNamex64 = "QuickMon" + $major + "." + $minor + "." + $build + "x64.msi"
