...
namespace HenIT.Windows.Controls
{
    ...
    public class TreeListView : System.Windows.Forms.ListView
    {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), DefaultValue(true)]
        [Browsable(true), Description("Allow items to be sorted at run-time by clicking on the column headers")]
        ...
        private void InitializeComponent()
        {
            ...
            this.plusMinusImageList.Images.SetKeyName(0, "Collapsed16x16.png");
            this.plusMinusImageList.Images.SetKeyName(1, "Expanded16x16.png");
            this.plusMinusImageList.Images.SetKeyName(2, "TriangleRight.ico");
            this.plusMinusImageList.Images.SetKeyName(3, "TriangleRightDown.ico");
            this.plusMinusImageList.Images.SetKeyName(4, "");
            this.plusMinusImageList.Images.SetKeyName(5, "");
            // 
            // TreeListView
            // 
